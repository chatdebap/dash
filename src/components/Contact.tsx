        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <div className="mt-8 space-y-3">
              <a href={PHONE_HREF} className="group flex items-center gap-4 rounded-2xl border border-neutral-800/80 bg-neutral-900/50 p-4 transition-colors hover:border-accent-500/50">
                <span className="grid h-11 w-11 place-items-center rounded-xl bg-accent-500/10 text-accent-400"><Phone className="h-5 w-5" /></span>
                <div><p className="text-xs text-neutral-500">Call us</p><p className="text-sm font-semibold text-white">{PHONE}</p></div>
              </a>
              <a href={TEXT_HREF} className="group flex items-center gap-4 rounded-2xl border border-neutral-800/80 bg-neutral-900/50 p-4 transition-colors hover:border-accent-500/50">
                <span className="grid h-11 w-11 place-items-center rounded-xl bg-accent-500/10 text-accent-400"><MessageSquare className="h-5 w-5" /></span>
                <div><p className="text-xs text-neutral-500">Text us</p><p className="text-sm font-semibold text-white">{PHONE}</p></div>
              </a>
              <a href={EMAIL_HREF} className="group flex items-center gap-4 rounded-2xl border border-neutral-800/80 bg-neutral-900/50 p-4 transition-colors hover:border-accent-500/50">
                <span className="grid h-11 w-11 place-items-center rounded-xl bg-accent-500/10 text-accent-400"><Mail className="h-5 w-5" /></span>
                <div><p className="text-xs text-neutral-500">Email us</p><p className="text-sm font-semibold text-white">{EMAIL}</p></div>
              </a>
              <div className="flex items-center gap-4 rounded-2xl border border-neutral-800/80 bg-neutral-900/50 p-4">
                <span className="grid h-11 w-11 place-items-center rounded-xl bg-accent-500/10 text-accent-400"><MapPin className="h-5 w-5" /></span>
                <div><p className="text-xs text-neutral-500">Based in</p><p className="text-sm font-semibold text-white">Cumberland, GA · Atlanta area</p></div>
              </div>
              <div className="flex items-center gap-4 rounded-2xl border border-neutral-800/80 bg-neutral-900/50 p-4">
                <span className="grid h-11 w-11 place-items-center rounded-xl bg-accent-500/10 text-accent-400"><Clock className="h-5 w-5" /></span>
                <div><p className="text-xs text-neutral-500">Response time</p><p className="text-sm font-semibold text-white">Within 24 hours</p></div>
              </div>
            </div>
          </div>

          <div className="rounded-3xl border border-neutral-800/80 bg-neutral-900/50 p-6 sm:p-8">
            {submitted ? (
